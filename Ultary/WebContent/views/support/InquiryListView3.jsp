...
<body>
	<div id="all">
		<div id="all-wrap">
			<%@ include file="../common/layout/import.jsp"%>
				...
				<section id="content">
					...
					<!-- 페이징 -->
							<div class="pagingArea" align="center">
								...
								<!-- 맨 처음으로 -->
								<button
									onclick="location.href='<%=request.getContextPath()%>/list.inq?currentPage=1&option=<%=option%>&search=<%=search%>&check=<%=check%>'">&lt;&lt;</button>
								...
								<!-- 맨 끝으로 -->
								<button
									onclick="location.href='<%=request.getContextPath()%>/list.inq?currentPage=<%=maxPage%>&option=<%=option%>&search=<%=search%>&check=<%=check%>'
